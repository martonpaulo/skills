...
If findings expand beyond focused reuse decisions into boundaries, ownership, coupling, or broader restructuring, recommend `architecture-audit`. That skill owns the broad assessment; `build-or-reuse` owns individual reuse decisions.
