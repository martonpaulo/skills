...
Choose one label defined in [SKILL.md](../SKILL.md) and put it first.

## Concise decision

Use for narrow or low-risk questions:

1. decision;
2. concise rationale;
3. main tradeoff;
4. confidence;
5. next verification step, only when needed.

## Detailed decision

Use for material choices:

1. decision;
2. assumptions and must-haves;
3. strongest candidates;
4. custom-build baseline;
5. meaningful tradeoffs;
