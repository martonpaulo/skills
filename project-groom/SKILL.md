...
A pass that dumps the backlog to disk to map it keeps that dump in a uniquely named system temporary directory and deletes it before reporting completion, per [`github-conventions`](../github-conventions/SKILL.md).
