...
class DiskCleaner:
    ...
    def get_cleanable_locations(self) -> Dict[str, List[str]]:
        ...
        if self.system == "windows":
            ...
            # iOS device backups are deliberately NOT listed as cleanable. They are
            # irreplaceable user data and must only be removed by the user, through
            # Finder or the Devices UI, after an explicit decision.
